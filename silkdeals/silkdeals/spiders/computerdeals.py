    ...
    def parse(self, response):
        ...
        for product in products:
            yield {
                ...
                'store_name' : self.remove_characters(product.xpath("normalize-space(.//button[@class='itemStore bp-p-storeLink bp-c-linkableButton  bp-c-button bp-c-button--link']/text())").get()),
